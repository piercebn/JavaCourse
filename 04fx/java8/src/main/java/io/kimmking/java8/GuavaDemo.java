...
public class GuavaDemo {
    ...
    public void handle(AEvent ae){
        System.out.println(Thread.currentThread().getName()+" "+ae.student + " is running for AEvent.");
    }

    @Subscribe
    public void handle(BEvent ae){
        System.out.println(Thread.currentThread().getName()+" "+ae.student + " is running for BEvent.");
    }
