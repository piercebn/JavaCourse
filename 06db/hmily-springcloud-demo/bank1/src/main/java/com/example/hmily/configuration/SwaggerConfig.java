package com.example.hmily.configuration;
...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_SCAN_BASE_PACKAGE = "com.example.hmily.controller.AccountController";
...
//                .licenseUrl("http://www.apache.org/licenses/LICENSE-2.0.html")
                .termsOfServiceUrl("")
                .version(VERSION)
                .contact(new Contact("baon", "", "17729531@qq.com"))
                .build();
    }
